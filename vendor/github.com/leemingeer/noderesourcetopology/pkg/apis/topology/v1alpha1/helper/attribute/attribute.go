...
func Get(attributes v1alpha1.AttributeList, name string) (v1alpha1.AttributeInfo, bool) {
	attr := findAttrByName(attributes, name)
	if attr == nil {
		return v1alpha1.AttributeInfo{}, false
	}
	return *attr, true
}
...
func Insert(attributes v1alpha1.AttributeList, attr v1alpha1.AttributeInfo) v1alpha1.AttributeList {
	if attr.Name == "" {
		return attributes
	}
...
func Merge(existing, updated v1alpha1.AttributeList) v1alpha1.AttributeList {
	ret := existing.DeepCopy()
	delta := v1alpha1.AttributeList{}
...
func DeleteAll(attributes v1alpha1.AttributeList, name string) v1alpha1.AttributeList {
	ret := make(v1alpha1.AttributeList, 0, len(attributes))
...
func findAttrByName(attributes v1alpha1.AttributeList, name string) *v1alpha1.AttributeInfo {
